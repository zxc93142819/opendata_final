        ...
        if event.source.user_id not in machine_dict:
            machine_dict[event.source.user_id] = TocMachine(
                ...
                transitions=[
                    ...
                    {"trigger": "advance" , "source": "user" , "dest": "input_key" , "conditions": "is_going_to_input_key",},
                    {"trigger": "advance" , "source": "input_key" , "dest": "stock_input_key" , "conditions": "is_going_to_stock_input_key",},
                    {"trigger": "advance" , "source": "stock_input_key" , "dest": "stock_input_key" , "conditions": "is_going_to_stock_input_key",},
